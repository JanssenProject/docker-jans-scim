...
def find_current_jans_package_version_and_build_date(dockerfile):
    ...
    jans_version_search_string = "ENV CLOUD_NATIVE_VERSION="
    jans_build_date_search_string = "ENV CLOUD_NATIVE_BUILD_DATE="
    jans_package = ""
    jans_version = ""
    jans_build_date = ""
...
def update_build_date(dockerfile, old_build_date, new_build_date):
    ...
    jans_build_date_search_string = "CLOUD_NATIVE_BUILD_DATE=" + '"' + old_build_date + '"'
    wrends_build_new_date_string = 'WRENDS_BUILD_DATE=' + '"' + new_build_date + '"'
    jans_build_new_date_string = "CLOUD_NATIVE_BUILD_DATE=" + '"' + new_build_date + '"'
    with open(dockerfile, "r+") as file:
        contents = file.read()
